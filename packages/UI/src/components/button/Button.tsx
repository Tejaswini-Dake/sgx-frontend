...
import { ButtonProps, ButtonSize, ButtonRadius, ButtonVariant } from './Button.types';
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantMap: Record<ButtonVariant, string> = {
    ...
    ghost: 'bg-transparent border border-sgx-blue text-sgx-blue hover:bg-sgx-bg-blue',
    white: 'bg-white text-sgx-dark-grey hover:bg-gray-100 border border-gray-200',
    outline:
